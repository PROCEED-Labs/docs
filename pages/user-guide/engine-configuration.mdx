...
![Config file in Engine folder](/images/user-guide/engine/config.json_file.png?width=400px&classes=border)
...
![Configuration web page of the Engine](/images/user-guide/engine/configuration-tab.png?width=400px&classes=border)
...
![One discovered Machine in the Machine view](/images/user-guide/engine/machine_discovered_full.png?width=1200px&classes=border)
...
![One discovered Machine in the Machine view](/images/user-guide/engine/configuration_modal.png?width=1000px&classes=border)
