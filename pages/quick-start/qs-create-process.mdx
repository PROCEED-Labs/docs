...
In this tutorial, we will create a simple process which will cover the following
concepts.
...
We assume that the installation of PROCEED components are done and the machines
are added according to [Installation](qs-install).
...
- Define a simple process by clicking "Process Management" in the menu and
  ...
  ![menu_mgmt_process](/docs/images/quick-start-create-process/menu_mgmt_process.png)
...
- Provide the process with a name, e.g. "First Process". You can optionally add
  ...
  ![process_mgmt_add_process_popup](/docs/images/quick-start-create-process/process_mgmt_add_process_popup.png)
...
- The process that was just created will be in the list of processes. For each
  ...
  ![process_actions](/docs/images/quick-start-create-process/process_actions.png)

- For the newly created process, click the edit icon to create a BPMN diagram
  like below using the editor.
  ![simple_process_bpmn](/docs/images/quick-start-create-process/simple_process_bpmn.png)
...
- Convert "Activity 1" to a script-task by right-clicking the activity and
  ...
  ![simple_process_convert_to_script_task](/docs/images/quick-start-create-process/simple_process_convert_to_script_task.png)

You should now see and icon on the top-left of the activity.
![script_task_activity_1](/docs/images/quick-start-create-process/script_task_activity_1.png)

- Clicking on any script task will display a button on the top of the BPMN
  editor to provide/edit the script for the task.
  ![edit_script_action](/docs/images/quick-start-create-process/edit_script_action.png)

![script_editing_ide](/docs/images/quick-start-create-process/script_editing_ide.png)
...
![process_mgmt_select_device](/docs/images/quick-start-create-process/process_mgmt_select_device.png)

- At this stage, the separated processes should look like the below figure,
  ![separated_processes](/docs/images/quick-start-create-process/separated_processes.png)
...
- Click "Save" from the top-right actions to save your changes. Optionally, you
  ...
  ![show_separation](/docs/images/quick-start-create-process/show_separation.png)
